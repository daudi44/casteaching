    ...
    <div class="bg-gray-900">
        <div class="pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
            <div class="text-center">
                <p class="mt-2 text-3xl font-extrabold text-white sm:text-4xl lg:text-5xl pb-5">Subscriu-te per veure el contingut</p>
                <h2 class="text-lg leading-6 font-semibold text-gray-300 uppercase tracking-wider">Pricing</h2>
                <p class="mt-3 max-w-4xl mx-auto text-xl text-gray-300 sm:mt-5 sm:text-2xl">Escull el pla de pagament que millor s'adapti a les teves necessitats</p>
            </div>
        </div>
            ...
            <div class="relative z-0">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div class="h-full flex flex-col rounded-lg shadow-lg overflow-hidden lg:rounded-none lg:rounded-l-lg">
                                <div class="flex-1 flex flex-col">
                                    <div class="bg-white px-6 py-10">
                                        <div>
                                            <h3 class="text-center text-2xl font-medium text-gray-900" id="tier-hobby">Basic</h3>
                                            <div class="mt-4 flex items-center justify-center">
                      <span class="px-3 flex items-start text-6xl tracking-tight text-gray-900">
                        <span class="pl-5 mt-2 mr-2 text-4xl font-medium"> € </span>
                        <span class="font-extrabold"> 9.51 </span>
                      </span>
                                    ...
                                    <div class="flex-1 flex flex-col justify-between border-t-2 border-gray-100 p-6 bg-gray-50 sm:p-10 lg:p-6 xl:p-10">
                                        <ul role="list" class="space-y-4">
                                            <li class="flex items-start">
                                                ...
                                                <p class="ml-3 text-base font-medium text-gray-500">Accés a 3 series a escollir</p>
                                            </li>
                                            ...
                                            <li class="flex items-start">
                                                ...
                                                <p class="ml-3 text-base font-medium text-gray-500">Accés a 10 vídeos a escollir</p>
                                            </li>

                                        </ul>
                                        <div class="mt-8">
                                            <div class="rounded-lg shadow-md">
                                                <a href="{{ route('subscribe')}}" class="block w-full text-center rounded-lg border border-transparent bg-white px-6 py-3 text-base font-medium text-indigo-600 hover:bg-gray-50" aria-describedby="tier-hobby"> Comença ara! </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mt-10 max-w-lg mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-start-3 lg:col-end-6 lg:row-start-1 lg:row-end-4">
                            <div class="relative z-10 rounded-lg shadow-xl">
                                ...
                                <div class="bg-white rounded-t-lg px-6 pt-12 pb-10">
                                    <div>
                                        <h3 class="text-center text-3xl font-semibold text-gray-900 sm:-mx-6" id="tier-growth">Advanced</h3>
                                        <div class="mt-4 flex items-center justify-center">
                    <span class="px-3 flex items-start text-6xl tracking-tight text-gray-900 sm:text-6xl">
                      ...
                      <span class="font-extrabold"> 19.02 </span>
                    </span>
                                ...
                                <div class="border-t-2 border-gray-100 rounded-b-lg pt-10 pb-8 px-6 bg-gray-50 sm:px-10 sm:py-10">
                                    <ul role="list" class="space-y-4">
                                        <li class="flex items-start">
                                            ...
                                            <p class="ml-3 text-base font-medium text-gray-500">Accés a 10 series a escollir</p>
                                        </li>
                                        ...
                                        <li class="flex items-start">
                                            ...
                                            <p class="ml-3 text-base font-medium text-gray-500">Accés a 20 vídeos a escollir</p>
                                        </li>
                                        ...
                                        <li class="flex items-start">
                                            ...
                                            <p class="ml-3 text-base font-medium text-gray-500">Accés a penjar vídeos propis</p>
                                        </li>
                                    </ul>
                                    <div class="mt-10">
                                        <div class="rounded-lg shadow-md">
                                            <a href="{{ route('subscribe')}}" class="block w-full text-center rounded-lg border border-transparent bg-indigo-600 px-6 py-4 text-xl leading-6 font-medium text-white hover:bg-indigo-700" aria-describedby="tier-growth"> Comença ara! </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                      ...
                      <span class="px-3 flex items-start text-6xl tracking-tight text-gray-900">
                        <span class="mt-2 mr-2 text-4xl font-medium"> € </span>
                        <span class="font-extrabold"> 28.52 </span>
                      </span>
                                                <span class="text-xl font-medium text-gray-500"> /month </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex-1 flex flex-col justify-between border-t-2 border-gray-100 p-6 bg-gray-50 sm:p-10 lg:p-6 xl:p-10">
                                        <ul role="list" class="space-y-4">
                                            <li class="flex items-start">
                                                ...
                                                <p class="ml-3 text-base font-medium text-gray-500">Accés a totes les series</p>
                                            </li>
                                        ...
                                        <div class="mt-8">
                                            <div class="rounded-lg shadow-md">
                                                <a href="{{ route('subscribe')}}" class="block w-full text-center rounded-lg border border-transparent bg-white px-6 py-3 text-base font-medium text-indigo-600 hover:bg-gray-50" aria-describedby="tier-scale"> Comença ara! </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
