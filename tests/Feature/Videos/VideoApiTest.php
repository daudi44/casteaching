...
class VideoApiTest extends TestCase
{
     ...
     * @test
     */
    public function returns_404_when_update_an_unexisting_video()
    {
        $this->loginAsVideoManager();

        $response = $this->putJson('/api/videos/323452345');
    ...
    public function users_with_permissions_can_update_videos()
    {
        ...
        $dbVideo = $response = $this->putJson('/api/videos/' . $video->id, $newVideo = [
            'title' => 'xd',
            'description' => 'xd',
            'url' => 'xd'
        ]);
     ...
     * @test
     */
    public function returns_404_when_deleting_an_unexisting_video()
    {
        $this->loginAsVideoManager();

        $response = $this->deleteJson('/api/videos/323452345');
     ...
     * @test
     */
    public function guest_users_cannot_show_published_videos()
    {
